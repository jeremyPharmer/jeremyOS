...
| 6 | RB-029 | Evening close success: day recap + world news | P0 | Ready | M | TBD |
| 7 | RB-016 | Five-year / paper journal UX | P0 | In Progress | M | TBD |
| 8 | RB-021 | Journal photos (attach + paperclip) | P1 | Backlog | S | TBD |
| 9 | RB-022 | Journal edit, star & month calendar | P0 | In Progress | M | TBD |
...
6. **RB-029 — Evening close success: day recap + world news** — **Ready / P0.** Intake 2026-09-11: fix empty-quotes Headline bug on Remember/success; replace thin/broken headline echo with a **general day recap** + **3–5 major world news headlines**; journal `oneLine` stays personal (do not overload with news). Rules-based v1. Effort **M**. Detail: [`items/evening-close-recap-news.md`](./items/evening-close-recap-news.md).
7. **RB-016 — Five-year / paper journal UX** — same calendar day across years; headline + short summary; journal vibes (not stacked cards). Detail: [`items/five-year-journal-ux.md`](./items/five-year-journal-ux.md). Distinct from RB-010 backfill integrity.
8. **RB-021 — Journal photos (attach + paperclip)** — optional pics on journal/evening entries; paperclip (or similar) on year slots when a photo is present; tap to view; **reuse** existing photo infra. Detail: [`items/journal-photos.md`](./items/journal-photos.md).
...
9. LLM / generative morning briefing — after [RB-027](./items/morning-day-start-briefing.md) rules-based v1.
...
**Done:** RB-007 accounts + onboarding; **RB-020** drop craving stats + Home craving CTA; **RB-023** calendar iCal + Google (Home agenda + Settings; superseded env/Today’s Build PR #70 approach); **RB-027** morning day-start briefing; **RB-028** Journey vitals BP+HR.
...
| Now (personal tools) | RB-014 todos (**Ready / L**) → **RB-026 task groups + calendar M/D** (**In Progress / M**, locked 2026-09-08; one first ship) → **RB-027 morning** (**Done**) → **RB-029 evening close recap + news** (**Ready / P0 / M**, locked 2026-09-11; fix empty-quotes + day recap + 3–5 headlines; do not overload journal `oneLine`) → RB-016 five-year journal → **RB-021 journal photos** | Merged Today’s Items + master page; groups/colors + Home no-completed; morning Done; evening = success-screen recap/news pair; journal cluster still in flight |
...
| Later / paused | RB-008, RB-004, **RB-025 Home Entertainment park**, RB-026 v2 group CRUD, RB-027/RB-029 LLM briefing/recap | Unrequested channels + Entertainment demoted; group add/rename after fixed v1 groups; generative copy after rules-based morning/evening |
...
| Done (rituals / vitals) | **RB-027** morning briefing; **RB-028** Journey vitals BP+HR | Evening close recap/news is **RB-029** (Ready) |
