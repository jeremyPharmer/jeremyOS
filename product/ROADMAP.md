...
| Now (personal tools) | RB-014 todos (**Ready / L**) → **RB-026 task groups + calendar M/D** (**In Progress / M**, locked 2026-09-08; one first ship) → RB-016 five-year journal → **RB-021 journal photos** | Merged Today’s Items + master page; groups/colors + Home no-completed + Tasks completed chevrons; nav-tab risk vs RB-012; journal cluster still in flight |
