...
| 5 | RB-027 | Redesigned morning day-start (check-in + briefing) | P0 | Ready | M | TBD |
...
5. **RB-027 — Redesigned morning day-start** — **Ready / P0.** Locked 2026-09-10: five metrics all **1–10** (sleep hours unified); tap-a-number (no sliders); drop intention; post-check-in **templated briefing** (quote + day summary; weather / feeling / calendar / tasks / free time); suggest snoozed/deferred tasks into calendar gaps; **no** morning Items checklist (Home tasks). Ship & iterate live; LLM briefing later. Related: agenda past 9PM in separate PR. Effort **M**. Detail: [`items/morning-day-start-briefing.md`](./items/morning-day-start-briefing.md).
