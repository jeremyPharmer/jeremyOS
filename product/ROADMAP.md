...
**Done:** RB-007 accounts + onboarding; **RB-020** drop craving stats + Home craving CTA; **RB-023** calendar iCal + Google (Home agenda + Settings; superseded env/Today’s Build PR #70 approach); **RB-027** morning day-start briefing; **RB-028** Journey vitals BP+HR; **RB-029** evening close recap + news; **RB-030** conversational morning briefing; **RB-034** Bills panel on Home (Buffalo Bills / NFL).
