...
| 5 | RB-032 | Daily briefing: Open / Close redesign | P0 | In Progress | L | TBD |
...
| Now (personal tools + rituals) | RB-014 todos (**Ready / L**) → **RB-026 task groups + calendar M/D** (**In Progress / M**) → **RB-032 Daily briefing Open/Close** (**In Progress / L**, locked 2026-09-12; iterates Done RB-027/029/030) → RB-016 five-year journal → **RB-021 journal photos** | Merged Today’s Items + master page; groups/colors; ritual twin redesign is the active Open/Close ship |
