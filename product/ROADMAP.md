...
| 6 | RB-036 | Task analytics on Tasks page + motion polish | P0 | In Progress | S | TBD |
| 7 | RB-002 | Gmail inbox centralization | P0 | Ready | L | TBD |
| 8 | RB-032 | Daily briefing: Open / Close redesign | P0 | Done | L | TBD |
| 9 | RB-027 | Redesigned morning day-start (check-in + briefing) | P0 | Done | M | TBD |
...
13. **RB-021 — Journal photos (attach + paperclip)** — optional pics on journal/evening entries; paperclip (or similar) on year slots when a photo is present; tap to view; **reuse** existing photo infra. Detail: [`items/journal-photos.md`](./items/journal-photos.md).
...
8. **RB-034 — Bills panel on Home** — **Done** (shipped 2026-09-13). Buffalo Bills (NFL) lean card at bottom of Home: ESPN schedule; W–L + division standing + streak; hide outside **Aug 1 – Mar 1**; tap → ESPN clubhouse. Rank **21**. Effort **M**. Detail: [`items/bills-panel-home.md`](./items/bills-panel-home.md).
9. **RB-035 — Schroeder soccer panel on Home** — **Ready / recommended lock 2026-09-15.** Webster Schroeder varsity boys soccer glance card **under Bills**; **Warriors** branding (logo badge); **Hudl** schedule + W–L/standing/streak; hide outside **Aug 15 – Nov 15**; stub HTML is reference only. Rank **22**. Effort **M**. Detail: [`items/schroeder-soccer-panel-home.md`](./items/schroeder-soccer-panel-home.md).
...
9. LLM / generative morning / evening briefing — after [RB-032](./items/daily-briefing-open-close-redesign.md) rules-based Daily briefing twin (parents [RB-027](./items/morning-day-start-briefing.md) / [RB-029](./items/evening-close-recap-news.md) / [RB-030](./items/morning-briefing-conversational.md)).

**Won't Do:** RB-009 recovery patterns / craving analytics (founder: drop craving stats).  
**Done:** RB-007 accounts + onboarding; **RB-020** drop craving stats + Home craving CTA; **RB-023** calendar iCal + Google (Home agenda + Settings; superseded env/Today’s Build PR #70 approach); **RB-027** morning day-start briefing; **RB-028** Journey vitals BP+HR; **RB-029** evening close recap + news; **RB-030** conversational morning briefing; **RB-034** Bills panel on Home (Buffalo Bills / NFL). **Ready (Home sports follow-on):** **RB-035** Schroeder soccer panel (under Bills).
...
| Now (personal tools + rituals) | RB-014 todos (**Ready / L**) → **RB-026 task groups + calendar M/D** (**In Progress / M**) → **RB-033 track over time** (**In Progress / S**) → **RB-036 task analytics + motion** (**In Progress / S**) → **RB-002 Gmail inbox** (**Ready / L**; OAuth spike OK; full ship after mid-flight IP) → **RB-032 Daily briefing Open/Close** (**Done / L**, shipped prod 2026-09-12) → RB-016 five-year journal → **RB-021 journal photos** | Merged Today’s Items + master page; groups/colors; Tasks page stats + snooze/complete motion; Gmail inbox centralization elevated 2026-09-15; ritual twin redesign shipped |
...
| Done (rituals / vitals) | **RB-027** morning briefing; **RB-028** Journey vitals BP+HR; **RB-029** evening recap+news; **RB-030** conversational morning | Parents shipped; active twin redesign = **RB-032**; LLM polish later; vitals chart cut + med adherence = **RB-031** |
| Done (Home sports) | **RB-034** Bills panel on Home | ESPN schedule + W–L/division/streak; Aug 1–Mar 1; ESPN tap-out |
| Next (Home sports) | **RB-035** Schroeder soccer panel on Home | Under Bills; Warriors mark; Hudl; Aug 15–Nov 15; boys varsity |
