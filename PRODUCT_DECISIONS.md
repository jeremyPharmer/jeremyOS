...
**Morning** — Start the day (sleep + mood/state on 1–10 taps + one focus line) → day-start briefing (quote + written summary); tasks stay on Home; focus line feeds evening close later  
